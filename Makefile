...
ENVTEST_K8S_VERSION = 1.20.0

PROVIDERS = coredns cloudflare hetzner scaleway ovh
...
deploy-manifests:
	...
	@kubectl kustomize config/common > deploy/common.yaml
	@for p in $(PROVIDERS); do \
		kubectl kustomize config/providers/$$p > deploy/$$p.yaml; \
	done
